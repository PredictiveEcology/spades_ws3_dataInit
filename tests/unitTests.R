...
test_dir("/media/data/gparadis/dev_/fiim/modules/dataInit/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/media/data/gparadis/dev_/fiim/modules/dataInit/tests/testthat/test-template.R")
